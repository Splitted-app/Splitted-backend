...
{
    /// <inheritdoc />
    public partial class AddedTransactionentityandmanytomanybetweenUserandTransaction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AutoCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
